...
class Imagenet16H(object):
    ...
    def __init__(self,args):
        ...
        self.raw_data_path = os.path.abspath(os.path.join(__file__,
                            "../../../data/imagenet-16H/imagenet_16h.pkl"))
    ...
    def get_data(self):
        ...
        rand_experts = np.random.choice(range(self.max_experts),
                                        replace=False,size=self.max_experts)
        self.args.chosen_experts = rand_experts[:self.args.num_experts]
        self.data['expert_preds'] = self.data['expert_preds'][rand_experts]

        self._get_targets()
        self._get_model_perf()

        self.data['expert_preds'] = self.data['expert_preds'][
