...
model_hyperparams = {
    "posterior_error_rate":list(np.arange(0.01, 0.07,0.005)),
    "rand_expert_query_perc": list(np.arange(0.10,0.9,0.01)),

    "qbc_entropy_tuning_param": list(np.arange(0.3,6,0.1)),
    "mp_tuning_param": list(np.arange(0.5,7,0.1))
}
